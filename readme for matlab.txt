...
addpath('/scCURE/matlab') %it should be ensured that all .m files are in the same work path

%%%%Data Prepare%%%%
%%%% PS:the demo original data which download from the release called demo-originaldata
...
%%Step1:load scRNA-seq data%%
load data_CD8;

%%Step2: gene filtering for random noise reduction using OGFSC%%
...
%%Step3:PCA for dimentional reduction%%
data = [data11, data22];
...
%%Step5:put 'changed' or 'unchanged' label for each cell%%
